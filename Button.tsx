...
export default function Button(props: Props) {
    ...
    return (
        <button
            ...
            className={`${getButtonSizeClassName(size)} ${getButtonVariantClassName(variant)} relative w-${width} font-semibold ${props.loading ? 'text-transparent justify-center cursor-not-allowed' : 'hover:bg-opacity-80'} rounded-lg inline-flex ${props.className}`}
        >
            {props.loading && (
